# Peggle-Lib PS3 - Biblioteca de Modding para peggle suportando PS3 <--> PC

Conjunto de ferramentas Python para extrair, editar e reconstruir arquivos `.pak` do Peggle (PS3).
